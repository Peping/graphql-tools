...
function createProxyingResolver(targetSchema, targetOperation, targetField, transforms) {
    return function (parent, args, context, info) {
        return delegateToSchema_1.default(targetSchema, targetOperation, targetField, {}, context, info, transforms);
    };
}
