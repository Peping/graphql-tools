...
var enumSchema = schemaGenerator_1.makeExecutableSchema({
    typeDefs: enumTest,
    resolvers: {
        Color: {
            RED: '#EA3232',
        ...
        describe('merging ' + combination.name, function () {
                            ...
                            mergedSchema = mergeSchemas_1.default({
                                schemas: [
                                    ...
                                    },
                                    {
                                        ...
                                        schema: testingSchemas_1.subscriptionSchema,
                                    },
                                ],
                                resolvers: {
                                    Property: {
                                        bookings: {
                                            ...
                                            resolve: function (parent, args, context, info) {
                                                return info.mergeInfo.delegate('Booking', 'query', 'bookingsByPropertyId', {
                                    ...
                                    Booking: {
                                        property: {
                                            ...
                                            resolve: function (parent, args, context, info) {
                                                return info.mergeInfo.delegate('Property', 'query', 'propertyById', {
                                    ...
                                    Query: {
                                        delegateInterfaceTest: function (parent, args, context, info) {
                                            return info.mergeInfo.delegate('Property', 'query', 'interfaceTest', {
                                                kind: 'ONE',
                                            }, context, info);
                                        },
                                        ...
                                        node: {
                                            ...
                                            resolve: function (parent, args, context, info) {
                                                if (args.id.startsWith('p')) {
                                                    return info.mergeInfo.delegate('Property', 'query', 'propertyById', args, context, info);
                                                }
                                                else if (args.id.startsWith('b')) {
                                                    return info.mergeInfo.delegate('Booking', 'query', 'bookingById', args, context, info);
                                                }
                                                else if (args.id.startsWith('c')) {
                                                    return info.mergeInfo.delegate('Booking', 'query', 'customerById', args, context, info);
                                                }
                                                else {
                                        ...
                                        nodes: function (parent, args, context, info) {
                                            return __awaiter(this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0: return [4 /*yield*/, info.mergeInfo.delegate('Booking', 'query', 'bookings', {}, context, info)];
                                                        case 1:
                                                            bookings = _a.sent();
                                                            return [4 /*yield*/, info.mergeInfo.delegate('Property', 'query', 'properties', {}, context, info)];
                                                        case 2:
                                                            properties = _a.sent();
            ...
            describe('basic', function () {
                ...
                it('works with custom enums', function () { return __awaiter(_this, void 0, void 0, function () {
                    var enumResult, mergedResult;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, graphql_1.graphql(enumSchema, "\n            query {\n              color\n              numericEnum\n            }\n          ")];
                            case 1:
                                enumResult = _a.sent();
                                return [4 /*yield*/, graphql_1.graphql(mergedSchema, "\n            query {\n              color\n              numericEnum\n            }\n          ")];
                            case 2:
...
describe('mergeSchema options', function () {
    describe('should filter types', function () {
        var schema;
        before(function () { return __awaiter(_this, void 0, void 0, function () {
            var bookingSchema, createTypeFilteringVisitTypes;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, testingSchemas_1.remoteBookingSchema];
                    case 1:
                        bookingSchema = _a.sent();
                        createTypeFilteringVisitTypes = function (typeNames) {
                            return function (name, candidates) {
                                if (['ID', 'String', 'DateTime'].includes(name) ||
                        ...
                        schema = mergeSchemas_1.default({
                            ...
                            resolvers: {
                                Query: {
                                    bookingById: function (parent, args, context, info) {
                                        return info.mergeInfo.delegate('Booking', 'query', 'bookingById', args, context, info);
                                    },
                                },
                            },
