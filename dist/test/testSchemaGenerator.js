...
describe('attachDirectiveResolvers on field', function () {
    ...
    it('throws error if trying use undefined Directive', function () {
        return chai_1.expect(function () {
            schemaGenerator_1.makeExecutableSchema({
                typeDefs: "\n          type RootQuery {\n            hello: String @deprecated(reason: \"Built-in directive work as normal\") @upper\n          }\n          schema {\n            query: RootQuery\n          }\n        ",
                resolvers: {
                    RootQuery: {
                        hello: function () { return 'never touch'; },
                    },
                },
                directiveResolvers: directiveResolvers,
            });
        }).to.throw('Directive @upper is undefined. Please define in schema before using');
    });
});
